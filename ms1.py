...
# --- KONFIGURASI UNTUK MS1 ---
PORT = 5051
DB_FILE = "DB-A.db" # Database A
...
if __name__ == "__main__":
    print(f"MS1 Running on Port {PORT} connected to {DB_FILE}")
    uvicorn.run("ms1:app", host="0.0.0.0", port=PORT, reload=True)